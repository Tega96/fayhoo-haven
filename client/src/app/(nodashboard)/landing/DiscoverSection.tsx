...
const DISCOVER = [
    ...
    },
    {
        ...
        description: "Once you've found the perfect rental property, easily book it online with just a click"
    },
    {
        ...
        <div className="max-w-6xl xl:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
            ...
            >
                ...
                <p className="mt-2 text-gray-500 max-w-3xl mx-auto">
                    ...
                    home that meets al your needs. Start your search today and discover your dream rental property!
                </p>
            </motion.div>
