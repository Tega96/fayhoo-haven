        ...
        <div className="fixed top-0 left-0 z-50 w-full h-11 shadow-xl">
            <div className="flex justify-between items-center w-full bg-primary-700 text-white py-3 px-8">
                ...
                <div className="flex items-center gap-5">
                    {authUser ? (
                        <>
                            <div className="reletive hidden md:block">
                                <MessageCircle className="w-6 h-6 cursor-pointer text-primary-200 hover:text-primary-50" />
                                <span className="absolute top-0 right-0 w-2 h-2 bg-secondary-700 rounded-full"></span>
                            </div>
                            <div className="reletive hidden md:block">
                                <Bell className="w-6 h-6 cursor-pointer text-primary-200 hover:text-primary-50" />
                                <span className="absolute top-0 right-0 w-2 h-2 bg-secondary-700 rounded-full"></span>
                            </div>
                                ...
                                <DropdownMenuTrigger className="flex items-center gap-2 focus:outline-none">
                                    <Avatar>
                                        ...
                                        <AvatarFallback className="bg-primary-600">
                                            {authUser.userRole?.[0].toLowerCase()}
                                        </AvatarFallback>
                                    </Avatar>
                                    <p className='text-primary-200 hidden md:block'>
